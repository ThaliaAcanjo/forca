...
class Game:
   ...
   def displayStart(self):
     print("Abstract class: Game.You need to create an instance of some specific subclass!")

   # show appropriate display depending on outcome of last guess
   def displayU(self, outcome):
     if outcome == 0:
       self.outcome = 0
...
class Guess:
  def __init__(self, value=None):
    if value is not None:
      self.theValue = value.upper()  # Garanta que a entrada seja maiúscula
    else:
      self.theValue = ''
